...
export const OpenHandsSettings = makeProviderSettingsSchema(
  {
    ...
    binaryPath: makeBinaryPathSetting("openhands").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the OpenHands CLI binary.",
        providerSettingsForm: { placeholder: "openhands", clearWhenEmpty: "omit" },
      }),
    ),
    customModels: Schema.Array(CustomModelSetting).pipe(
      Schema.withDecodingDefault(Effect.succeed([])),
...
export type OpenHandsSettings = typeof OpenHandsSettings.Type;
...
export const ServerSettings = Schema.Struct({
  ...
  providers: Schema.Struct({
    ...
    openhands: OpenHandsSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
...
const OpenHandsSettingsPatch = Schema.Struct({
  enabled: Schema.optionalKey(Schema.Boolean),
  binaryPath: Schema.optionalKey(TrimmedString),
  customModels: Schema.optionalKey(Schema.Array(CustomModelSetting)),
});
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  providers: Schema.optionalKey(
    Schema.Struct({
      ...
      openhands: Schema.optionalKey(OpenHandsSettingsPatch),
